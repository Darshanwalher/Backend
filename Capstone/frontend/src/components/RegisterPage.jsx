...
import { Cpu, Mail, Lock, User, UserPlus, AlertCircle, Eye, EyeOff } from 'lucide-react';
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3.5">
          ...
          <div className="form-input-container">
            ...
            />
            <User className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#858585]" />
          ...
          <div className="form-input-container">
            ...
            />
            <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#858585]" />
            <label className="form-label text-[10px]">Confirm Password</label>
            <button
              type="button"
        ...
        <div className="text-center mt-4 text-xs text-[#858585]">
          ...
          <Link to="/login" className="text-[#569cd6] hover:underline font-semibold transition-colors">
            Sign in
          </Link>
        </div>
