...
import { LangChainError, ns } from "@langchain/core/errors";

//#region src/utils/errors.ts
const ns$1 = ns.sub("google");
/**
...
* ```
*/
var GoogleError = class extends ns$1.brand(LangChainError) {
	name = "GoogleError";
};
/**
...
* ```
*/
var ConfigurationError = class extends ns$1.brand(GoogleError, "configuration") {
...
* ```
*/
var PromptBlockedError = class PromptBlockedError extends ns$1.brand(GoogleError, "prompt-blocked") {
...
* ```
*/
var AuthError = class AuthError extends ns$1.brand(GoogleError, "auth") {
	name = "AuthError";
	/**
...
* ```
*/
var RequestError = class RequestError extends ns$1.brand(GoogleError, "request") {
	name = "RequestError";
	/**
...
* ```
*/
var NoCandidatesError = class extends ns$1.brand(GoogleError, "no-candidates") {
...
* ```
*/
var InvalidToolError = class extends ns$1.brand(GoogleError, "invalid-tool") {
...
* ```
*/
var ToolCallNotFoundError = class extends ns$1.brand(GoogleError, "tool-call-not-found") {
...
* ```
*/
var MalformedOutputError = class extends ns$1.brand(GoogleError, "malformed-output") {
...
* ```
*/
var InvalidInputError = class extends ns$1.brand(GoogleError, "invalid-input") {
	name = "InvalidInputError";
};

//#endregion
export { AuthError, ConfigurationError, InvalidInputError, InvalidToolError, MalformedOutputError, NoCandidatesError, PromptBlockedError, RequestError, ToolCallNotFoundError };
